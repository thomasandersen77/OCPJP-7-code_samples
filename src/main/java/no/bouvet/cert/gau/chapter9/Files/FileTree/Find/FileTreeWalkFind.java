package no.bouvet.cert.gau.chapter9.Files.FileTree.Find;

import java.io.IOException;
import java.nio.file.*;
import java.nio.file.attribute.*;

import static no.bouvet.cert.gau.chapter9.C9FilePath.C9_FILES_FILETREE_FIND_PATH;
...
public class FileTreeWalkFind{
    ...
    public static void main(String[] args) {
        // instead of console!
        method(C9_FILES_FILETREE_FIND_PATH, PATTERN);
