...
// I/ if remove() is called when there are no elements, then the queue blocks
// (i.e., waits) until an element is inserted. If insert() is called when the queue
// is full, then the queue blocks until an element is removed
public class BlockerQueue {
    ...
    //remove an element if available; or if there are no elements in teh queue,
    ...
    // insert an element if there is apace for insertion. If queue is full,
    ...
    public void insert(Object element){
        ...
        try{
            ...
            // an element is inserted, so any other thread can remove it...
